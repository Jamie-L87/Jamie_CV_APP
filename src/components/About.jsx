    ...
    <section className="about">
      <div className="container">
        ...
        <div className="about-content">
          <p>
            Digital Product Manager at Herman Miller leading the EOS Cloud initiative, a strategic IT system used internationally across the UK, Europe, Asia, India, and Australia.
